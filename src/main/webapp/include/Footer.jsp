          ...
          <div class="col">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">주변정보</a></li>
                <li><a href="#" class="py-2 d-block">객실목록</a></li>
                <li><a href="#" class="py-2 d-block">예약</a></li>
                <li><a href="#" class="py-2 d-block">회원가입</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">개인정보 보호 정책</a></li>
                <li><a href="#" class="py-2 d-block">예약 취소 정책</a></li>
                <li><a href="#" class="py-2 d-block">환불 정책</a></li>
              </ul>
            </div>
          </div>
          <div class="col">
