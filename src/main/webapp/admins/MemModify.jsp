		...
		<div class="row justify-content-center">
			...
			<div class="rightside">
				<div class="include-gap">
					<form id="MemModify">
						<h3
							style="margin-bottom: 60px; font-weight: bold; margin-left: 105px;">관리자
							회원 정보수정</h3>
						<table summary="관리자 회원 정보수정 " border="1">
							...
							<tbody>
								...
								<tr>
									<td
										style="background-color: #73685d; color: #fff; width: 200px; height: 70px;">고객명</td>
									<td class="td-special"><input type="text" name="name"
										value="<c:out value="${MemOne.memName}" />"
										onkeyup="chkword(this, 20)" required></td>
								</tr>
								<tr>
									<td
										style="background-color: #73685d; color: #fff; width: 200px; height: 70px;">아이디</td>
									<td><input type="text" name="id"
										value="<c:out value="${MemOne.memId }"/>"
										onkeyup="chkword(this, 20)" readonly></td>
								</tr>
								<tr>
									<td
										style="background-color: #73685d; color: #fff; width: 200px; height: 70px;">비밀번호</td>
									<td><input type="password" name="pwview" value="******"
										onkeyup="chkword(this, 20)" onchange="updateValue(this, pw)"
										required> <input type="hidden" name="pw"
										value="${MemOne.memPw}"></td>
								</tr>
								<tr>
									<td
										style="background-color: #73685d; color: #fff; width: 200px; height: 70px;">이메일</td>
									<td><input type="email" name="email"
										value="<c:out value="${MemOne.memEmail}"/>"
										onkeyup="chkword(this, 20)" required></td>
								</tr>
								<tr>
									<td
										style="background-color: #73685d; color: #fff; width: 200px; height: 70px;">전화번호</td>
									<td><input type="text" name="call"
										value="<c:out value="${MemOne.memCall}"/>"
										onkeyup="chkword(this, 20)" required></td>
								</tr>
								...
								<tr>
									<td style="height: 70px;" align="right" colspan="2">
										...
										<button type="button" class="btn_css"
											onclick="deletedata('${MemOne.memId}')">삭제</button>
